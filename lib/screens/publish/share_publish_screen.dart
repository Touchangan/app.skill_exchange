import 'dart:convert';
import 'dart:io';
import 'skill_publish_screen.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:shared_preferences/shared_preferences.dart';
import 'package:image_picker/image_picker.dart'; // 添加 image_picker 包

class SharePublishScreen extends StatefulWidget {
  @override
  _SharePublishScreenState createState() => _SharePublishScreenState();
}

class _SharePublishScreenState extends State<SharePublishScreen> {
  ...
  Future<void> _submitPost() async {
    ...
    final postData = {
      "user_id": userId,
      "share_content": shareContent, // 转换为 JSON 格式
      "share_date": DateTime.now().toIso8601String(), // 当前时间
    };
    ...
    final url = Uri.parse("http://120.46.200.190:5500/api/shares");
    try {
